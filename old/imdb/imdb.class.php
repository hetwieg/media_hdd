<?php
 ...
 /* $Id: imdb.class.php 464 2011-08-20 21:49:07Z izzy $ */
  ...
  * @version $Revision: 464 $ $Date: 2011-08-20 23:49:07 +0200 (Sa, 20. Aug 2011) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 464 $');
    $this->setid($id);
  }
